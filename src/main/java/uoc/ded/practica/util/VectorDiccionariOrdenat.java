...
public class VectorDiccionariOrdenat<Clau extends Comparable<Clau>, Element> extends DiccionariVectorImpl<Clau, Element> implements ContenidorAfitat<Element> {
    private final int elementsMaxims;

    public VectorDiccionariOrdenat(int elementsMaxims) {
    ...
    private int binarySearch(Clau key, int left, int right) {
        ...
        Clau extracted = diccionari[mid].getClau();
        int compare = extracted.compareTo(key);
